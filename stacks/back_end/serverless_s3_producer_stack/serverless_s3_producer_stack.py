        ...
        **kwargs
        ...
        data_producer_fn = _lambda.Function(
            ...
            environment={
                "LOG_LEVEL": "INFO",
                "APP_ENV": "Production",
                "STORE_EVENTS_BKT": f"arn:aws:s3:{cdk.Aws.REGION}:{cdk.Aws.ACCOUNT_ID}:accesspoint/{sales_lambda_ap_name}",
                "TRIGGER_RANDOM_DELAY": "True"
            },
        )

        # Grant our Lambda Producer privileges to write to S3
        # sales_event_bkt.grant_write(data_producer_fn)
